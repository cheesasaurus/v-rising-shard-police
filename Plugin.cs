...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .shardpolice-example "some quoted string" 1 1.5
    // /// .shardpolice-example boop 21232
    // /// .shardpolice-example boop-boop
    // ///</remarks>
    // [Command("shardpolice-example", description: "Example command from shardpolice", adminOnly: true)]
